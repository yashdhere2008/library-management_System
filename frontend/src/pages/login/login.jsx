...
const LoginPage = () => {
  ...
  const submitLogin = async () => {
    ...
    try {
      ...
      if (normalizedRole === "student" && rollNo) {
        payload.rollNo = rollNo.trim(); // <-- Send Roll No in login payload
      }
  ...
  const handleRegister = async (e) => {
    ...
    if (!name || !email || !password || (normalizedRole === "student" && !rollNo)) {
      setMessage("⚠ Please fill all registration fields.");
      return;
    }
    ...
    try {
      ...
      if (normalizedRole === "student") {
        payload.rollNo = rollNo.trim(); // <-- Send Roll No in registration payload
      }
    ...
    <div className="login-container">
      <div className="login-box">
        ...
        <div className={`form ${mode === "login" ? "active" : ""}`}>
          ...
          {/* Conditional Roll No field for Login */}
          {role === "student" && (
            <div className="input-box">
              <input
                type="text"
        ...
        <div className={`form ${mode === "register" ? "active" : ""}`}>
          ...
          {/* Conditional Roll No field for Registration */}
          {role === "student" && (
            <div className="input-box">
              <input
                type="text"
...
>>>>>>> 3752155 (Update student dashboard and library system)
